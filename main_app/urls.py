...
from .views import index, register, loginView, homeView, transactionsView, statisticsView, statisticsBalanceView, statisticsCashFlowView, statisticsSpendingView, statisticsReportView
...
urlpatterns = [
    ...
    path('statistics/report/', statisticsReportView, name='statisticsReportView'),
